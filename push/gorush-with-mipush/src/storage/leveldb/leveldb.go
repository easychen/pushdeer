...
func (s *Storage) GetMISuccess() int64 {
	var count int64
	s.getLevelDB(storage.MISuccessKey, &count)
...
func (s *Storage) GetMIError() int64 {
	var count int64
	s.getLevelDB(storage.MIErrorKey, &count)
